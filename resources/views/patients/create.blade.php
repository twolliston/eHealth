@extends('layouts.app') 
@section('title') Create a Patient 
@stop 
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form action="/patients" method="post">
        ...
        <div class="form-row">
          ...
          <fieldset class="form-group col-md-4">
            ...
            <input name="middle" class="form-control" placeholder="Middle Name">
          </fieldset>
        ...
        <div class="form-row">
          ...
          <fieldset class="form-group col-md-4">
            ...
            <input name="address_2" class="form-control" type="text" value="" placeholder="Apt/Condo Number">
          </fieldset>
        </div>
        ...
        <div class="form-group col-md-3">
          ...
          <fieldset class="form-group col-md-3">
            ...
            <input name="postalcode" class="form-control" placeholder="Zip Code" required>
          </fieldset>
        </div>
      ...
      <div class="form-row" style="float:right">
        ...
        <button class="btn btn-warning" style="margin-left:15px"><a href="/home" style="color:black; text-decoration:none">Cancel</a></button>
    </div>
